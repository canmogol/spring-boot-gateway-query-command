...
public class ResponseExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<Object> handle(ProductSaveException e, ServletWebRequest request) {
        log.error("Product could not be saved, message: {}, product: {}", e.getMessage(), e.getProduct());
